...
| `test_bundle_structures.py` | 12 | Optional 6th (structures) bundle part round-trip + `bundle --structures`/`--minify-structures` CLI flags, incl. raw ColabFold output naming |
